...
object HistoryConstSalary2020 {
    ...
    val WORKING_SHIFT_WEEK:Int = HistoryConstSalary2019.WORKING_SHIFT_WEEK
    val WORKING_SHIFT_TIME:Int = HistoryConstSalary2019.WORKING_SHIFT_TIME
    val MIN_MONTHLY_WAGE:Int = 14600
    val MIN_HOURLY_WAGE:Int = 8730
}
