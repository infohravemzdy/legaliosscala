...
object HistoryConstSalary2021 {
    ...
    val WORKING_SHIFT_WEEK:Int = HistoryConstSalary2020.WORKING_SHIFT_WEEK
    val WORKING_SHIFT_TIME:Int = HistoryConstSalary2020.WORKING_SHIFT_TIME
    val MIN_MONTHLY_WAGE:Int = 15200
    val MIN_HOURLY_WAGE:Int = 9050
}
