...
{
    val LIM_MONTHLY_DIS50:Int = 6259
}

object HistoryConstHealth2014 {
    val VERSION_CODE = 2014

    val MIN_MONTHLY_BASIS:Int = HistoryConstSalary2014.MIN_MONTHLY_WAGE
    val MAX_ANNUALS_BASIS:Int = HistoryConstHealth2013.MAX_ANNUALS_BASIS
    val LIM_MONTHLY_STATE:Int = HistoryConstHealth2013.LIM_MONTHLY_STATE
    val LIM_MONTHLY_DIS50:Int = HistoryConstHealth2013var11.LIM_MONTHLY_DIS50
    ...
    val MARGIN_INCOME_EMP:Int = HistoryConstHealth2013.MARGIN_INCOME_EMP
    val MARGIN_INCOME_AGR:Int = HistoryConstHealth2013.MARGIN_INCOME_AGR
}
