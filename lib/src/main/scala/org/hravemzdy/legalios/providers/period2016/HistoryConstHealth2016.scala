...
object HistoryConstHealth2016 {
    ...
    val MIN_MONTHLY_BASIS:Int = HistoryConstSalary2016.MIN_MONTHLY_WAGE
    val MAX_ANNUALS_BASIS:Int = HistoryConstHealth2015.MAX_ANNUALS_BASIS
    val LIM_MONTHLY_STATE:Int = HistoryConstHealth2015.LIM_MONTHLY_STATE
    val LIM_MONTHLY_DIS50:Int = 6444
    ...
    val MARGIN_INCOME_EMP:Int = HistoryConstHealth2015.MARGIN_INCOME_EMP
    val MARGIN_INCOME_AGR:Int = HistoryConstHealth2015.MARGIN_INCOME_AGR
}
