...
object HistoryConstTaxing2021 {
    ...
    val ALLOWANCE_PAYER:Int = 2320
    val ALLOWANCE_DISAB_1ST:Int = HistoryConstTaxing2020.ALLOWANCE_DISAB_1ST
    val ALLOWANCE_DISAB_2ND:Int = HistoryConstTaxing2020.ALLOWANCE_DISAB_2ND
    val ALLOWANCE_DISAB_3RD:Int = HistoryConstTaxing2020.ALLOWANCE_DISAB_3RD
    val ALLOWANCE_STUDY:Int = HistoryConstTaxing2020.ALLOWANCE_STUDY
    val ALLOWANCE_CHILD_1ST:Int = HistoryConstTaxing2020.ALLOWANCE_CHILD_1ST
    val ALLOWANCE_CHILD_2ND:Int = HistoryConstTaxing2020.ALLOWANCE_CHILD_2ND
    val ALLOWANCE_CHILD_3RD:Int = HistoryConstTaxing2020.ALLOWANCE_CHILD_3RD
    val SETTLEMENT_CHILD_2ND:Int = 1860
    val SETTLEMENT_CHILD_3RD:Int = 2320
    ...
    val MIN_AMOUNT_OF_TAXBONUS:Int = HistoryConstTaxing2020.MIN_AMOUNT_OF_TAXBONUS
    val MAX_AMOUNT_OF_TAXBONUS:Int = HistoryConstTaxing2020.MAX_AMOUNT_OF_TAXBONUS
    val MARGIN_INCOME_OF_TAXBONUS:Int = (HistoryConstSalary2021.MIN_MONTHLY_WAGE / 2)
    val MARGIN_INCOME_OF_ROUNDING:Int = HistoryConstTaxing2020.MARGIN_INCOME_OF_ROUNDING
    val MARGIN_INCOME_OF_WITHHOLD:Int = HistoryConstTaxing2020.MARGIN_INCOME_OF_WITHHOLD
    val MARGIN_INCOME_OF_SOLIDARY:Int = 0
    val MARGIN_INCOME_OF_TAXRATE2:Int = (4 * 35441)
    val MARGIN_INCOME_OF_WHT_EMP:Int = 3500
    val MARGIN_INCOME_OF_WHT_AGR:Int = HistoryConstTaxing2020.MARGIN_INCOME_OF_WHT_AGR
}
