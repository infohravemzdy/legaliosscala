...
object HistoryConstHealth2018 {
    ...
    val MIN_MONTHLY_BASIS:Int = HistoryConstSalary2018.MIN_MONTHLY_WAGE
    val MAX_ANNUALS_BASIS:Int = HistoryConstHealth2017.MAX_ANNUALS_BASIS
    val LIM_MONTHLY_STATE:Int = HistoryConstHealth2017.LIM_MONTHLY_STATE
    val LIM_MONTHLY_DIS50:Int = 7177
    ...
    val MARGIN_INCOME_EMP:Int = HistoryConstHealth2017.MARGIN_INCOME_EMP
    val MARGIN_INCOME_AGR:Int = HistoryConstHealth2017.MARGIN_INCOME_AGR
}
