...
import org.hravemzdy.legalios.service.types.{OperationsDec, TaxDeclSignOption, TaxNoneSignOption, VersionId}
...
object PropsTaxing2010 {
  def empty(): IPropsTaxing = {
    return new PropsTaxing2010(PropsBase.VERSION_ZERO)
  }
}
