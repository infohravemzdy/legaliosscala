...
class Service_Legalios_Example_03_Social_07_MarginIncomeEmpTest extends AnyFunSpec {
  val testList = List(
  ...
  ServiceExampleBase.logTestIntExamples("03_Social_07_MarginIncomeEmp.txt", testList)
  testList.foreach { tx =>
